...
const About = () => {
  return (
    <>
      <h1>About Us</h1>
      <p>We are a travel company dedicated to providing the best experiences in Nepal.</p>
      <p>Our team consists of experienced guides and travel enthusiasts who are passionate about sharing the beauty of Nepal with the world.</p>
